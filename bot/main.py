...
def load_json():
    ...
    class Settings:
        def __init__(self, json_data):
            self.bot_server_port = int(json_data["settings"]["bot_server_port"])
            self.bot_server_ip = json_data["settings"]["bot_server_ip"]
            ...
            self.room_prefix = json_data["preferences"]["room_prefix"]
            self.max_users_in_room = int(json_data["preferences"]["max_users_in_room"])
